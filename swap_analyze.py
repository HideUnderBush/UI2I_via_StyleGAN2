...
img2, _ = g_ema2([sample_z], truncation=0.5, truncation_latent=mean_latent2, swap=True, swap_tensor=swap_res[2])
img2_name = args.output + "_direct.png"
...
img3_name = args.output + "_origin.png"
...
#     print(i)
#     img4_name = args.output + "_b_style" + str(i) + ".png"
#     img4 = make_image(img4)
#     out4 = Image.fromarray(img4[0])
#     out4.save(img4_name)